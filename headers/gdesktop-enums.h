...
typedef enum
{
  G_DESKTOP_STYLUS_ERASER_BUTTON_MODE_DEFAULT,
  G_DESKTOP_STYLUS_ERASER_BUTTON_MODE_BUTTON,
} GDesktopStylusEraserButtonMode;
...
typedef enum
{
  G_DESKTOP_MOUSE_SCROLL_METHOD_DEFAULT,
  G_DESKTOP_MOUSE_SCROLL_METHOD_NONE,
  G_DESKTOP_MOUSE_SCROLL_METHOD_ON_BUTTON_DOWN
} GDesktopMouseScrollMethod;
