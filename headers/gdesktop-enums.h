...
typedef enum
{
    G_DESKTOP_DEVICE_SCROLL_METHOD_DEFAULT,
    G_DESKTOP_DEVICE_SCROLL_METHOD_NONE,
    G_DESKTOP_DEVICE_SCROLL_METHOD_2FG,
    G_DESKTOP_DEVICE_SCROLL_METHOD_EDGE,
    G_DESKTOP_DEVICE_SCROLL_METHOD_ON_BUTTON_DOWN
} GDesktopDeviceScrollMethod;
